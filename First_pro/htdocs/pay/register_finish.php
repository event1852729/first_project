...
$GetOldIdSQL ="SELECT pay.py_id FROM pay ORDER BY py_id DESC limit 1";
...
$ServerURL = "http://140.126.146.49:20001/pay/$ImagePath";
...
//確認密碼輸入的正確性
       ...
       $seldb = @mysqli_select_db($db_link,"commun");
          if(!$seldb) die("資料庫選擇失敗!!");
        //新增資料進資料庫語法
        $sql = "insert into pay (py_title,py_content) values ('$py_title','$a$DefaultId$b')";
