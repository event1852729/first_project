...
WHERE (message.mg_mb_id =$mg_mb_id and message.r_mb_id = $r_mb_id and message.mg_mb_id = member.mb_id)or(message.mg_mb_id =$r_mb_id 
and message.r_mb_id =$mg_mb_id
and message.mg_mb_id=member.mb_id)
ORDER BY mg_date ASC";
...
//and message.r_mb_id =$mg_mb_id
//and message.mg_mb_id=member.mb_id)ORDER BY mg_date DESC";
